  ...
  const columns: any = [
    ...
    // },
    {
      ...
      render: (text: any, record: any,index:number) => {
        const durations=["00:30:15","01:12:45", "00:43:21", "02:05:10", "00:55:32"]
    ...
    },
    {
      ...
      render: (text: any, record: any,index: number) => {
        const durations = ["00:25:15", "01:08:45", "00:39:21", "01:59:10", "00:48:32"];
        
        // return <Link to="#" onClick={() => { getDataById(record?.id); showConfirm(record?.id, record?.name, "update", record?.status) }}><EditOutlined /></Link>;
        return durations[index % durations.length];
      },
    },
