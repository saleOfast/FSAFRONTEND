...
import { getAllOrdersListService, getOrderListByStoreIdService, updateOrderTrackStatusService, createOrderService } from "services/orderService";
    ...
    <div>
      ...
      <div className="store-v1">
        ...
        <main>
          ...
          <div className="content" style={{ display: "flex", flexWrap: "wrap", gap: "20px", marginTop: "24px", marginBottom: "10px", width: "100%" }}>
            {
              orderList && orderList?.length > 0 && orderList.map((data: any, index: any) => {
                const { isCallType, orderId, store, orderAmount, orderDate, storeId, products, orderStatus, specialDiscountValue, specialDiscountStatus, specialDiscountComment, paymentStatus } = data
                return (
